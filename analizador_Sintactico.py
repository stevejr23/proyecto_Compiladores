...
class ReglasSintacticas:
    ...
    def leer_reglas(self):
        file = open('proyecto_Compiladores/data/compilador.lr','r')
...
class AnalizadorSintactico(ReglasSintacticas):
    ...
    def analizadorSintacticoEnteros(self, cadena):
        ...
        while self.salidaEntero != -1:
            ...
            if self.salidaEntero < -1:
                ...
                print('Error: La sintaxis no es correcta en la {} "{}"'.format(self.item_selected[2],self.item_selected[0]))
                return False
            else:
    ...
    def analizarSimbolos(self):
        # Creamos un objeto de tipo AnalizadorLexico y lo inicializamos con el valor de la candena
