...
class TipoCadena:
    ...
    def __init__(self):
        self.TIPOS_DATOS = ['int', 'string', 'float', 'double', 'void','boolean']
        self.ERROR = -2
...
class AnalizadorLexico(TipoCadena):
    ...
    def tipoCadena(self, tipo):
        ...
        switch = {
            ...
            self.Iron: self.m_IF,
            self.Majo: self.m_WHILE,
            self.RETURN: self.m_RETURN,
            self.Man: self.m_ELSE,
    ...
    def verificarPalabraReservada(self, simbolo):
        ...
        if self.tipo >= self.Iron and self.tipo <= self.Man:
    ...
    def m_IF(self):
        self.tipoCadenaMensaje = "Iron"

    def m_WHILE(self):
        self.tipoCadenaMensaje = "Majo"

    def m_RETURN(self):
        self.tipoCadenaMensaje = "Return"

    def m_ELSE(self):
        self.tipoCadenaMensaje = "Man"
